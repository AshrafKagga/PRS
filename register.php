...
if(isset($_POST["submit"])){
  ...
  $duplicate = mysqli_query($conn, "SELECT * FROM tb_user WHERE username like '$username' OR email like '$email' ");
  // var_dump($duplicate);
  if(mysqli_num_rows($duplicate) > 0){
    echo "<script> alert('User name or email is taken');</script>";
  }
  else{
    if($password == $c_password){
      $sql = "INSERT INTO tb_user(name,email,username,password) VALUES('$name','$email','$username','$password')";
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="cards-title text-center pb-0 fs-4">Create an Account</h5>
                    <p class="text-center small">Enter your personal details to create account</p>
                  </div>

                  <form class="row g-3 needs-validation" action="register.php" method="post" autocomplete="on">
                    <div class="col-12">
